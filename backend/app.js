...
const NBContract = require('./nb_contract.js');
const DatasetContract = require('./dataset_contract.js');


const loginContract = LoginContract.at(process.env.LOGIN_CONTRACT_ADDRESS || '0xf7b06365e9012592c8c136b71c7a2475c7a94d71');
const nbContract = NBContract.at(process.env.NB_CONTRACT_ADDRESS || '0xf7b06365e9012592c8c136b71c7a2475c7a94d71');
const datasetContract = DatasetContract.at(process.env.DATASET_CONTRACT || '0xf7b06365e9012592c8c136b71c7a2475c7a94d71');
...
app.post('/createNB', validateJwt, (req, res) => {
    if(req.jwt.access !== 'full') {
        res.sendStatus(401); //Unauthorized
        return;
    }
